...
{/* <Bar data={barData} options={barConfig} type />
 ...
 const renderSwitch = () =>{
    switch(currentComponent){
       case 'barData': return <Bar data={barData} options={barConfig} type/>;
       case 'erasePieData': return (
       <div style={{position:"relative",height:"10vh",width:"10vw"}}><Pie data={erasePieData} options={{
         responsive: true,
       ...
       case 'linksPanel': return <div>Links</div>
    }
 }
  return (
    <>
