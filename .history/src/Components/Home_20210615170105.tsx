...
export const Home: React.FunctionComponent<{}> = () => {
          ...
          AccountService.refreshToken()
            .then((resp) => {
              ...
              FileUploadService.uploadFile(formData).then((resp2) =>
                ...
                setHasError(true);
                setErrorMessage(err3.response.data);
              })
            })
            .catch((err2) =>
             {
               ...
               setHasError(true);
               setErrorMessage(err2.response.data);
             }
            );
        ...
        <div>
          ...
          <Slider
            ...
            onChange={(event, value) => {
              let result = value as number/100
              setFlipProbability(result);
            }}
            style={{ maxWidth: "80%" }}
          />
          ...
          <Slider
            ...
            onChange={(event, value) => {
              let result = value as number/100
              setRotateProbability(result);
            }}
            style={{ maxWidth: "80%" }}
          />
          <div>
            <span>Flip and rotate on base dataset</span>
            <Checkbox
              checked={isFlipBase}
          ...
          <div>
            <span>Flip and rotate on CLAHE dataset</span>
            <Checkbox
              checked={isFlipClahe}
          ...
          <div>
            <span>Flip and rotate on grayscale dataset</span>
            <Checkbox
              checked={isFlipGray}
  ...
  return (
    <Card className={classes.root}>
      <Typography>Please select a .zip file</Typography>
      <CardContent>
