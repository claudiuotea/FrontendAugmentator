...
export const Stats: React.FunctionComponent<{}> = () => {
  ...
  const [currentComponent,setCurrentComponent] = useState('clahe')
  ...
  return (
    <>
      ...
      <RadioGroup aria-label="components" name="components" value={currentComponent} onChange={handleChange}>
        ...
        {isAdmin?<div>404</div>:<FormControlLabel value="flipPieData" control={<Radio />} label="Flip and rotate options" />}
      </RadioGroup>
    </FormControl>
