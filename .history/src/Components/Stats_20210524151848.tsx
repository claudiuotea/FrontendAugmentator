...
export const Stats: React.FunctionComponent<{}> = () => {
  ...
  const [flipPieData, setFlipPieData] = useState({})
   ...
   const flipPieChart = () =>{
      setFlipPieData({
         labels: ['Flip on base dataset','Flip on CLAHE dataset', 'Flip on grayscale dataset'],
  datasets: [
    {
      label: '# of uses',
   ...
   const erasePieChart = () =>{
         setErasePieData({
            labels: ['Erase on base dataset', 'Erase on CLAHE dataset', 'Erase on grayscale dataset'],
            datasets: [
              {
                label: '# of uses',
