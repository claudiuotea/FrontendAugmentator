...
import { DownloadFileInterface, ForgotPasswordInterface, LoginInterface, RegisterInterface, ResetPasswordInterface, VerfiyAccountInterface } from "../Models/Interfaces"
...
export default class AccountService{
   ...
   static downloadFile = (data: DownloadFileInterface) : Promise<any> =>{
      let refreshToken = window.localStorage.getItem('RefreshToken')
      ...
      return axios.post(`${AccountService.BASE_URL}/download`,data)   
   }
}